...
function deep_meta_boxes( $meta_boxes ) {
	// Post
	$meta_boxes[] = array(
		'title'			=> esc_attr__( 'Post Options', 'deep' ),
		'post_types'	=> 'post',
		'fields'		=> array(
			array(
			...
			array(
				...
				'type'		=> 'select',
				'options'	=> array(
					'themeopts' => esc_attr__( 'Use Default Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'     => array(
					'type0' => esc_attr__( 'Use Default Options', 'deep' ),
	...
	// Page
	$meta_boxes[] = array(
		'title'			=> esc_attr__( 'Page Options', 'deep' ),
		'post_types'	=> 'page',
		'fields'		=> array(
			array(
				...
				'type'	=> 'select',
				'options'     => array(
					'none' 	=> esc_attr__( 'Use Default Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'	=> array(
					'themeoptions'	=> esc_attr__( 'Use Default Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'	=> array(
					'inherit'	=> esc_attr__( 'Use Default Options', 'deep' ),
					'none'		=> esc_attr__( 'None', 'deep' ),
					'right'		=> esc_attr__( 'Right', 'deep' ),
					'left'		=> esc_attr__( 'Left', 'deep' ),
			...
			array(
				...
				'desc'	=> esc_attr__( 'To enable it you should set the option "Show Page Title" on "Hide" . If this page is supposed to be set as 404 page, please adjust it from Options > Pages > 404 page', 'deep' ),
				'std'	=> 'inherit',
			),
			array(
				'id'	=> 'deep_footer_show',
			...
			array(
				...
				'desc'	=> esc_attr__( 'More Options in Deep > Options > Pages > Edge Onepager', 'deep' ),
				'type'	=> 'switcher',
				'std'	=> 0,
			),
			array(
	...
	// Portfolio
	$meta_boxes[] = array(
		'title'			=> esc_attr__( 'Portfolio Options', 'deep' ),
	...
	// Mega Menu
	$meta_boxes[] = array(
		'title'			=> esc_attr__( 'Mega Menu Options', 'deep' ),
		...
		'fields'		=> array(
			...
			array(
				...
				'options'  	=> array(
					...
					'inherit'    => esc_html__( 'Use Default Options', 'deep' ),
	...
	if ( defined('RECIPES_DIR') ) {
		// recipes
		$meta_boxes[] = array(
			'title'			=> esc_attr__( 'Recipe Options', 'deep' ),
			'post_types'	=> 'recipe',
			'fields'		=> array(
				array(
	...
	if ( defined('CAUSES_DIR') ) {
		...
		$meta_boxes[] = array(
			'title'			=> esc_attr__( 'Cause Options', 'deep' ),
			'post_types'	=> 'cause',
			'fields'		=> array(
	...
	if ( defined('SERMONS_DIR') ) {
		...
		$meta_boxes[] = array(
			'title'			=> esc_attr__( 'Sermon Options', 'deep' ),
			'post_types'	=> 'sermon',
			'fields'		=> array(
	...
	if ( defined('GOAL_DIR') ) {
		$meta_boxes[] = array(
			'title'			=> esc_attr__( 'Goal Options', 'deep' ),
			'post_types'	=> 'goal',
			'fields'		=> array(
				array(
	...
	if ( class_exists( 'LifterLMS' ) ) {
		$meta_boxes[] = array(
			'title'			=> esc_attr__( 'Deep Course Options', 'deep' ),
			'post_types'	=> 'course',
			'fields'		=> array(
				array(
					'id'      => 'course_material_includes',
