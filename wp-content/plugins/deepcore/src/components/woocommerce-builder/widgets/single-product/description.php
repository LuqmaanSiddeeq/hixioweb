 ...
 * @since 2.0.0
 */
class Description extends Deep_Product_Widget_Base {
	 ...
	 * @var string
	 */
	public $deep_base_selector = '{{WRAPPER}} .deep-woo-description';
	...
	public function get_title() {
		return __( 'Product Description', 'deep' );
	}
	...
	protected function render() {
		...
		if ( $this->can_display_product() ) {
			...
			Templates::widget( 'description', array() );
		}
