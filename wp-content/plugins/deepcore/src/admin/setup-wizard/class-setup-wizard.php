			...
			<div class="wn-lb-content wn-suc-imp-content-wrap">
				<div class="wn-suc-imp-content">
					...
					<div class="wn-suc-imp-links">
						...
						<a class="wn-suc-imp-links-t" href="<?php echo esc_url( self_admin_url( 'admin.php?page=wn-admin-options' ) ); ?>"><?php esc_html_e( 'Options', 'deep' ); ?></a>
						<a class="wn-suc-imp-links-l" href="<?php echo esc_url( self_admin_url( 'admin.php?page=wn-admin-help' ) ); ?>" target="_blank"><?php esc_html_e( 'Help', 'deep' ); ?></a>
