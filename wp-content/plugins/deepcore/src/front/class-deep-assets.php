...
class Deep_Assets {
	...
	public function enqueue_scripts() {
         ...
         * Nice Select.
         */
		if ( is_plugin_active( 'lifterlms/lifterlms.php' ) || function_exists( 'pll_languages_list' ) ) {
        ...
        if ( function_exists( 'wpcf7_enqueue_scripts' ) ) {
            ...
            wp_enqueue_style( 'deep-contact-form7', DEEP_ASSETS_URL . 'css/frontend/contact-form/contact-form.css' );
        }
