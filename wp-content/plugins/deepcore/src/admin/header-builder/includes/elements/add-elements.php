...
<div class="whb-modal-wrap whb-elements">
	...
	<div class="whb-modal-contents-wrap">
		<div class="whb-modal-contents wp-clearfix">
			...
			<?php if ( is_plugin_active( 'wp-hotel-booking/wp-hotel-booking.php' ) ) : ?>
				<!-- Hotel Cart -->
			...
			<?php if ( is_plugin_active( 'lifterlms/lifterlms.php' ) ) : ?>
			<!-- Lifterlms search form -->
				<div class="whb-elements-item w-col-sm-4" data-element="lifterlms-search-form">
					<a href="#"><i class="ti-search"></i><span class="whb-element-name"><?php esc_html_e( 'Lifterlms Search', 'deep' ); ?></span></a>
				</div>
			<?php endif; ?>
