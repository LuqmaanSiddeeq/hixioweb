...
class Deep_Demo_Importer {
	...
	public function import_content() {
		...
		if ( class_exists( 'Woocommerce' ) ) {
			...
			if ( file_exists( $this->path . '/deep-woo-loops.xml' )  ) {
				...
				$importing_demo->import_content( $this->path . '/deep-woo-loops.xml' );
			}

			if ( file_exists( $this->path . '/deep-woo-dashboard.xml' )  ) {
				...
				$importing_demo->import_content( $this->path . '/deep-woo-dashboard.xml' );
			}

			if ( file_exists( $this->path . '/deep-woo-pages.xml' )  ) {
				$woo_pages = get_posts(
					array(
				...
				$importing_demo->import_content( $this->path . '/deep-woo-pages.xml' );
			}
			...
			if ( file_exists( $this->path . '/deep-woo-builder-options.json' )  ) {
				$content = file_get_contents( $this->path . '/deep-woo-builder-options.json' );
				$options = json_decode( $content, true );
				update_option( 'deep_woocommerce_dashboard', $options );
			}
		}
