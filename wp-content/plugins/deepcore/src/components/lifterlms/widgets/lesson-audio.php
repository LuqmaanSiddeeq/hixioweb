...
/**
 * Elementor widget for LifterLMS Lesson Audio.
 *
 * @since 5.0.0
 */
class LessonAudio extends Widget_Base {
	/**
	...
	public function get_title() {
		return __( 'LifterLMS Lesson Audio', 'deep' );
	}
	...
	public function get_icon() {
		return 'deep-widget deep-eicon-llms-lesson-audio';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'description',
			[
				'label' 	=> __( 'This widget displays the lesson audio for a specific lesson.', 'deep' ),
	...
	protected function render() {
		...
		?>
		<div class="deep-llms-lesson-audio">
			<?php
